                            ...
                            <div className="rounded-xl bg-white px-12 text-center">
                                ...
                                <p className="mt-4 pb-6  text-lg leading-6 text-black">
                                    <h2>
                                        ...
                                        successfully, you can start to sell
                                        tickets now.
                                    </h2>
                                    <br />
                                ...
                                <div className="pt-6 pb-20">
                                    <a href="/">
                                        <button className="inline-flex items-center rounded-full border border-transparent bg-black px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                                            Return to Home Page
                                        </button>
                                    </a>
                                </div>
